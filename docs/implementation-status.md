...
| 1.7 live custom MCP | Implemented | Final full fixture scan selected 19 real Strix tool calls through strict in-process MCP seams | Exhaustive browser/Caido/web tool autonomy remains unverified. |
